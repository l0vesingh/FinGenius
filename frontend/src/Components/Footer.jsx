      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
        <div className="col-span-1 sm:col-span-2">
          ...
          <div className="flex gap-4 mt-4">
            <a href="#"><FaTwitter className="w-5 h-5 hover:text-white cursor-pointer" /></a>
            <a href="#"><FaGithub className="w-5 h-5 hover:text-white cursor-pointer" /></a>
            <a href="#"><FaLinkedin className="w-5 h-5 hover:text-white cursor-pointer" /></a>
